...
const Headaches = ({navigation}) =>{
    ...
    const getDataFromDB = () =>{
        ...
        for (let index = 0; index < Items.length; index++) {
            if(Items[index].category == "headaches")
                HeadachesList.push(Items[index])
            
        }

        setHeadaches(HeadachesList);
                ...
                <View
                    style={{
                        ...
                        <Text
                         ...
                         Welcome to Running shoose Store 
                        </Text>
                        <Text
                         style={{
                             fontSize:14,
                         ...
                         Welcome to the LifeStyle shoose categories
